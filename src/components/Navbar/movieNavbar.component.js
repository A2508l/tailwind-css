...
import { BiChevronLeft,BiShareAlt,BsChevronRight, BiSearch, BiChevronDown, BiMenu } from "react-icons/bi";
const NavSm = () => {
return (
<>
...
return (
<>
<nav className="absolute inset-x-0 z-15 bg-opacity-10 backdrop-filter backdrop-blur-lg bg-navCol-800 px-4 py-2">
